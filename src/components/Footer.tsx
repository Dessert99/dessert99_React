    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <h3 className="mb-4 text-xl font-bold">회사 소개</h3>
            <p className="text-gray-400">
              저희 회사는 최고의 서비스를 제공하기 위해 노력하고 있습니다.
            </p>
          </div>
          <div>
            <h3 className="mb-4 text-xl font-bold">빠른 링크</h3>
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/" onClick={scrollTop} className="transition-colors hover:text-white">
                  홈
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="mb-5 text-xl font-bold">소셜 미디어</h3>
